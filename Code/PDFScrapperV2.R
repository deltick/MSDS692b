...
# written to a csv file for subsequent processing. 
# The input file is:
...
######################################################################
# Combine the transposed dataframes into on dataframe.
...
##################################################################
# Reformat month from character to month number
...
##################################################################
# Remove commas from numeric fields and convert to numeric
